...
Tokens are strings of cryptic text that the server issues and inspects. Using them, the server either allows or doesn't allow data transfer depending on the client's permissions. In other words, it's used for authenticating users.

- [ ] What steps can you take in your web apps to keep your data secure?

One step you can take is the use of protected routes to restict the acess to authenticated users. Another step you can take is make sure that user info like passwords isn't stored locally on plaintext which would make it easily accesible.

- [ ] Describe how web servers work.

The physical aspect of the web server is connected to the internet and stores the code. When the code is loaded for a website, it's being hosted by the server. The software aspect of the server (also called web server) gives users the webpages that it retrives from your code when they request it.
